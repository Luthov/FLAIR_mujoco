...
class BiteAcquisitionInference:
    ...
    def get_autonomous_action_no_decomposer(self, 
        ...
        if continue_food_label is not None:
            ...
            next_bite, bite_size, speed_of_acquisition, distance_to_mouth, exit_angle, speed_of_transfer, token_data = self.preference_planner.plan_no_decomposer(
                non_dip_labels, 
                non_dip_portions_rounded, 
                efficiency_scores, 
                preference, 
        ...
        return next_actions[idx], bite_size, speed_of_acquisition, distance_to_mouth, exit_angle, speed_of_transfer, token_data
    ...
    def get_autonomous_action_decomposer(self, 
        ...
        if continue_food_label is not None:
            ...
            next_bite, bite_size, speed_of_acquisition, distance_to_mouth, exit_angle, speed_of_transfer, token_data = self.preference_planner.plan_decomposer(
                non_dip_labels, 
                non_dip_portions_rounded, 
                efficiency_scores, 
                preference, 
